...
{
    public class EfServiceTypeDal : EfGenericRepository<ServiceType, MilkyCowDbContext>, IServiceTypeDal
    {
        public EfServiceTypeDal(MilkyCowDbContext context) : base(context)
        {
        }
    }
}
