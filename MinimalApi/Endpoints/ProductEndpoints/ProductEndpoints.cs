...
namespace MinimalApi.Endpoints.ProductEndpoints
{
    ...
    public class ProductEndpoints
    {
        ...
        public ProductEndpoints(IServiceManager serviceManager)
        {
        ...
        {
            endpoints.MapPost("/createproduct", async context =>
            {
                var product = await context.Request.ReadFromJsonAsync<Product>();
                if (product != null)
                {
                    _serviceManager.ProductService.Add(product);
            ...
            endpoints.MapGet("/getallproducts", async context =>
            {
